...
const SendAGiftContents = () => {
  return (
    <div className="flex flex-col justify-center items-center px-6 xl:px-0">
      ...
      >
        <p className="text-[12px] font-medium text-[#465967]">Send a Gift</p>
      </motion.div>
      ...
      <div>
        ...
        <p className="text-xs md:text-lg text-[#474747] max-w-2xl mx-auto font-semibold text-center">
          Browse our curated collection and have your gift delivered quickly and
          safely to any city in Bangladesh.
        </p>
      </div>
    </div>
  );
